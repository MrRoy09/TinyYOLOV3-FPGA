...
#
# Script generated by Vivado on Sat Feb 07 23:50:09 IST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TinyYOLOHW.sh
...
#
# Usage        : TinyYOLOHW.sh
#                TinyYOLOHW.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TinyYOLOHW.sh [-reset_run]
#                TinyYOLOHW.sh [-reset_log]
#                TinyYOLOHW.sh [-help]
#
...
# script info
echo -e "TinyYOLOHW.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TinyYOLOHW.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TinyYOLOHW xil_defaultlib.TinyYOLOHW xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TinyYOLOHW -key {Behavioral:sim_1:Functional:TinyYOLOHW} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TinyYOLOHW.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TinyYOLOHW.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TinyYOLOHW.sh [-help]\n\
Usage: TinyYOLOHW.sh [-step]\n\
Usage: TinyYOLOHW.sh [-lib_map_path]\n\
Usage: TinyYOLOHW.sh [-reset_run]\n\
Usage: TinyYOLOHW.sh [-reset_log]\n\
Usage: TinyYOLOHW.sh [-keep_index]\n\
Usage: TinyYOLOHW.sh [-noclean_files]\n\n\
