...
// ==============================================================
`timescale 1ns/1ps
module TinyYOLOHW_control_s_axi
#(parameter
    ...
    output wire [31:0]                   quant_M,
    output wire [31:0]                   quant_n,
    output wire [0:0]                    isMaxpool,
    output wire [0:0]                    is_1x1,
...
localparam
    ...
    ADDR_IER                 = 7'h08,
    ADDR_ISR                 = 7'h0c,
    ADDR_IMG_WIDTH_DATA_0    = 7'h10,
    ADDR_IMG_WIDTH_CTRL      = 7'h14,
    ADDR_IN_CHANNELS_DATA_0  = 7'h18,
    ADDR_IN_CHANNELS_CTRL    = 7'h1c,
    ADDR_OUT_CHANNELS_DATA_0 = 7'h20,
    ADDR_OUT_CHANNELS_CTRL   = 7'h24,
    ADDR_QUANT_M_DATA_0      = 7'h28,
    ADDR_QUANT_M_CTRL        = 7'h2c,
    ADDR_QUANT_N_DATA_0      = 7'h30,
    ADDR_QUANT_N_CTRL        = 7'h34,
    ADDR_ISMAXPOOL_DATA_0    = 7'h38,
    ADDR_ISMAXPOOL_CTRL      = 7'h3c,
    ADDR_IS_1X1_DATA_0       = 7'h40,
    ADDR_IS_1X1_CTRL         = 7'h44,
    ADDR_STRIDE_DATA_0       = 7'h48,
    ADDR_STRIDE_CTRL         = 7'h4c,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_quant_M = 'b0;
    reg  [31:0]                   int_quant_n = 'b0;
    reg  [0:0]                    int_isMaxpool = 'b0;
    reg  [0:0]                    int_is_1x1 = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_QUANT_M_DATA_0: begin
                    rdata <= int_quant_M[31:0];
                end
                ADDR_QUANT_N_DATA_0: begin
                    rdata <= int_quant_n[31:0];
                end
                ADDR_ISMAXPOOL_DATA_0: begin
                    rdata <= int_isMaxpool[0:0];
                end
                ADDR_IS_1X1_DATA_0: begin
                    rdata <= int_is_1x1[0:0];
                end
...
assign quant_M           = int_quant_M;
assign quant_n           = int_quant_n;
assign isMaxpool         = int_isMaxpool;
assign is_1x1            = int_is_1x1;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_QUANT_M_DATA_0)
            int_quant_M[31:0] <= (WDATA[31:0] & wmask) | (int_quant_M[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_QUANT_N_DATA_0)
            int_quant_n[31:0] <= (WDATA[31:0] & wmask) | (int_quant_n[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ISMAXPOOL_DATA_0)
            int_isMaxpool[0:0] <= (WDATA[31:0] & wmask) | (int_isMaxpool[0:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IS_1X1_DATA_0)
            int_is_1x1[0:0] <= (WDATA[31:0] & wmask) | (int_is_1x1[0:0] & ~wmask);
    end
end
