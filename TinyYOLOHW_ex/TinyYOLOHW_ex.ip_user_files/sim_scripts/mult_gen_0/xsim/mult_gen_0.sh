...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L mult_gen_v12_0_23 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_10 -L xbip_multadd_v3_0_22 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_gen_0 xil_defaultlib.mult_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_gen_0 -key {Behavioral:sim_1:Functional:mult_gen_0} -tclbatch cmd.tcl -log simulate.log -sv_seed 1
}
