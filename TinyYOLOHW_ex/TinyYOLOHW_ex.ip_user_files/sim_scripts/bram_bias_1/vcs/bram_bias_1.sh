...
#
# Script generated by Vivado on Sun Feb 08 00:50:48 IST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_bias_1.sh
...
#
# Usage        : bram_bias_1.sh
#                bram_bias_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_bias_1.sh [-reset_run]
#                bram_bias_1.sh [-reset_log]
#                bram_bias_1.sh [-help]
#
...
#                script (type 'bram_bias_1.sh -help' for more information).
#
...
# script info
echo -e "bram_bias_1.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_bias_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_bias_1 xil_defaultlib.glbl -o bram_bias_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_bias_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_bias_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_bias_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_bias_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_bias_1.sh [-help]\n\
Usage: bram_bias_1.sh [-step]\n\
Usage: bram_bias_1.sh [-lib_map_path]\n\
Usage: bram_bias_1.sh [-reset_run]\n\
Usage: bram_bias_1.sh [-reset_log]\n\
Usage: bram_bias_1.sh [-keep_index]\n\
Usage: bram_bias_1.sh [-noclean_files]\n\n\
