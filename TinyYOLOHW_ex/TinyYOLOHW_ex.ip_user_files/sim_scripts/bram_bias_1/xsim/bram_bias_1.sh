...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_bias_1 xil_defaultlib.bram_bias_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_bias_1 -key {Behavioral:sim_1:Functional:bram_bias_1} -tclbatch cmd.tcl -log simulate.log -sv_seed 1
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_bias_1.wdb xsim.dir libdpi.so)
