...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axi4stream_vip_v1_1_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_out_vip xil_defaultlib.axi_out_vip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_out_vip -key {Behavioral:sim_1:Functional:axi_out_vip} -tclbatch cmd.tcl -log simulate.log -sv_seed 1
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_out_vip.wdb xsim.dir libdpi.so)
