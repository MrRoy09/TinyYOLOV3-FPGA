...
#
# Script generated by Vivado on Sat Feb 07 23:51:39 IST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_out_vip.sh
...
#
# Usage        : axi_out_vip.sh
#                axi_out_vip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_out_vip.sh [-reset_run]
#                axi_out_vip.sh [-reset_log]
#                axi_out_vip.sh [-help]
#
...
#                script (type 'axi_out_vip.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axis_infrastructure_v1_1_1 -libname xil_defaultlib -libname axi4stream_vip_v1_1_21 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axis_infrastructure_v1_1_1 xil_defaultlib axi4stream_vip_v1_1_21)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_out_vip.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_out_vip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work axi4stream_vip_v1_1_21 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_out_vip xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_out_vip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_out_vip_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_out_vip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_out_vip.sh [-help]\n\
Usage: axi_out_vip.sh [-step]\n\
Usage: axi_out_vip.sh [-lib_map_path]\n\
Usage: axi_out_vip.sh [-reset_run]\n\
Usage: axi_out_vip.sh [-reset_log]\n\
Usage: axi_out_vip.sh [-keep_index]\n\
Usage: axi_out_vip.sh [-noclean_files]\n\n\
