...
design_libs=(xilinx_vip xpm axis_infrastructure_v1_1_1 xil_defaultlib axi4stream_vip_v1_1_21)
...
compile()
{
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work axi4stream_vip_v1_1_21 $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_out_vip xil_defaultlib.glbl -o axi_out_vip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_out_vip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_out_vip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_out_vip_simv.daidir vcs_lib c.obj)
