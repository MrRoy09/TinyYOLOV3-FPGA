...
#
# Script generated by Vivado on Sat Feb 07 23:51:41 IST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : control_TinyYOLOHW_vip.sh
...
#
# Usage        : control_TinyYOLOHW_vip.sh
#                control_TinyYOLOHW_vip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                control_TinyYOLOHW_vip.sh [-reset_run]
#                control_TinyYOLOHW_vip.sh [-reset_log]
#                control_TinyYOLOHW_vip.sh [-help]
#
...
#                script (type 'control_TinyYOLOHW_vip.sh -help' for more information).
#
...
xmsim_opts="-64bit -logfile simulate.log -SVSEED 1"

# set design libraries for elaboration
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_21 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_21)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "control_TinyYOLOHW_vip.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./control_TinyYOLOHW_vip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../../TinyYOLOHW_ex.gen/sources_1/ip/control_TinyYOLOHW_vip/sim/control_TinyYOLOHW_vip_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_21 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.control_TinyYOLOHW_vip xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.control_TinyYOLOHW_vip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log control_TinyYOLOHW_vip_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./control_TinyYOLOHW_vip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: control_TinyYOLOHW_vip.sh [-help]\n\
Usage: control_TinyYOLOHW_vip.sh [-step]\n\
Usage: control_TinyYOLOHW_vip.sh [-lib_map_path]\n\
Usage: control_TinyYOLOHW_vip.sh [-reset_run]\n\
Usage: control_TinyYOLOHW_vip.sh [-reset_log]\n\
Usage: control_TinyYOLOHW_vip.sh [-keep_index]\n\
Usage: control_TinyYOLOHW_vip.sh [-noclean_files]\n\n\
