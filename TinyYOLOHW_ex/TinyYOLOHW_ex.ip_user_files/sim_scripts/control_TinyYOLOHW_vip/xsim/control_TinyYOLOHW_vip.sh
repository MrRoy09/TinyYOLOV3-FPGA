...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi4stream_vip_v1_1_21 -L axi_vip_v1_1_21 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot control_TinyYOLOHW_vip xil_defaultlib.control_TinyYOLOHW_vip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim control_TinyYOLOHW_vip -key {Behavioral:sim_1:Functional:control_TinyYOLOHW_vip} -tclbatch cmd.tcl -log simulate.log -sv_seed 1
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/ubuntu/T7/Xilinx-tools/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb control_TinyYOLOHW_vip.wdb xsim.dir libdpi.so)
