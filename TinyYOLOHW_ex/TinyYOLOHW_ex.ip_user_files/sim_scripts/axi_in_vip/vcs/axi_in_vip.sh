...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_in_vip xil_defaultlib.glbl -o axi_in_vip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_in_vip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_in_vip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_in_vip_simv.daidir vcs_lib c.obj)
