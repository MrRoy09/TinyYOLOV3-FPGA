...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../Xilinx-tools/2025.1/data/rsb/busdef" +incdir+"/media/ubuntu/T7/Xilinx-tools/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bram_weights_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bram_weights_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bram_weights_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
